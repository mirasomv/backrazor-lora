...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 "ViT-L_32", "ViT-H_14", "R50-ViT-B_16", "ViT-S_16"],
                        default="ViT-B_16",
...
# LoRA
    parser.add_argument("--lora_rank", type=int, default=0, help="LoRA rank r (0 disables LoRA)")
    parser.add_argument("--lora_alpha", type=float, default=1.0, help="LoRA alpha (usually 2*r)")
    parser.add_argument("--lora_dropout", type=float, default=0.0, help="LoRA dropout")
    parser.add_argument("--lora_mlp", action="store_true", help="Also apply LoRA to MLP fc1/fc2")

# Train only LoRA (+ head), freeze backbone
    parser.add_argument("--train_lora_only", action="store_true",
                        help="Freeze backbone; train only LoRA params and classifier head")
